...
document.addEventListener("mousemove", (event) => {
  ...
  if (mouseX < windowWidth / 2) {
    document.body.style.cursor = "url(../public/archive/arrow--left.svg),auto";
  } else {
    document.body.style.cursor = "url(../public/archive/arrow--right.svg),auto";
  }
});
...
function nextSlide() {
  imgCounter = 1;
  slides[currentIndex].src = `../public/archive/secondaryImg/${Object.values(projects)[currentIndex].img + imgCounter}.png`;
...
function changeslide(){
    ...
    if (window.innerWidth < 650){
      slides[currentIndex].src = `../public/archive/secondaryImg/low_res/${Object.values(projects)[currentIndex].img+imgCounter}.png`;
    ...
    highResImage.src = `../public/archive/secondaryImg/${Object.values(projects)[currentIndex].img+imgCounter}.png`; // Replace with path to your high-resolution image
