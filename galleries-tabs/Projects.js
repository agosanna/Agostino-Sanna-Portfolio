const projects = {
    ...
    rr: {
      ...
      type: "CODING, UI",
      lon: 9.793699,
      text: `Ricettebrutte (ugly recipes) was born out of necessity and evolved into a concept celebrating the beauty of ugliness. The initial aim was to create a conventional recipe app using React Native, but free API images were awful and the recipes looked terrible. I decided to embrace the poor quality of the pictures and create an app for 'good recipes with ugly pictures'. If you have android you can download it <a href="../public/archive/RICETTEBRUTTE.apk" download="RICETTEBRUTTE.apk"  style="text-decoration: underline; cursor: pointer; font-size: 1em;">here</a>`,
      where: "ERASMUS PR.",
      how: "INDIVIDUAL",
      img: "RR_",
      imgs: 6,
    ...
    anth: {
      ...
      img: "ANTH_",
      imgs: 4,
      link: "http://anthropogenicnarratives.labsintesi-c1.info/index.html",
    },
    gg: {
    ...
    aer: {
      ...
      img: "AER_",
      imgs: 5,
      link: "https://vimeo.com/822959364",
    },
  };
